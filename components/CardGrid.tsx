...
export const CardGrid = () => {
  return (
    <div className="container max-w-[1920px] w-full mx-auto p-10">
      <div className="flex justify-center gap-16 p-10">
        <div className=" max-w-xl">
          <Card
            ...
            lorem="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nibh nibh eu in aliquet ut adipiscing neque. Sed volutpat aenean sit vitae, sed tristique nibh nibh eu in aliquet ut adipiscing neque. Sed volutpat aenean sit vitae, sed tristique. Sed volutpat aenean."
          />
        </div>
        <div className="grid-rows-3 grid-flow-col gap-7 max-w-lg">
          <Card
            font="font-pop"
            txt="Conheça as principais técnicas para conseguir uma vaga internacional em programação"
            date="Janeiro 04, 2022"
            lorem="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nibh nibh eu in aliquet ut adipiscing neque. Sed volutpat aenean sit vitae, sed tristique."
          />
          <Card
      ...
      <div className="flex mx-auto grid-rows-3 grid-flow-col gap-7 max-w-6xl">
        <Card
          img="/coding.svg"
